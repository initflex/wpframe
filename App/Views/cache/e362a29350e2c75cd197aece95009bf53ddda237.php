<div class="wpf-flex-container-1 wpf-spacing">
    <img class="wpf-logo-intro" src="<?php echo e($GLOBALS['WPFP_CONFIG']['assets_url'] .'images/logos/favicon-96x96.png'); ?>" alt="">
    <div class="wpf-text-center">
        <h1><?php echo e($GLOBALS['WPFP_CONFIG']['developer_app']); ?> - WPFrame</h1>
...
<div class="wpf-flex-container-2 wpf-spacing">
    <div class="wpf-box-container">
        <h1>Hello, <?php echo e(ucfirst($name)); ?> - Welcome!</h1>
        ...
        <div>
            <a href="<?php echo e($GLOBALS['WPFP_CONFIG']['developer_link']); ?>" target="_blank">
    ...
    <div class="wpf-box-container">
        <h1>System Info</h1>
        <p>PHP Version: <?php echo e(@PHP_VERSION); ?></p>
        <p>System: <?php echo e(@php_uname()); ?></p>
    </div>
</div>
...
</div><?php /**PATH E:\Applications\laragon\www\development-wpframe\wp6\wp-content\plugins\wpframe\App\Views/default_wpframe/index.blade.php ENDPATH**/ ?>